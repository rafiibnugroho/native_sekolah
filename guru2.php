...
<h3 class="ha3" style="text-align: center; font-family: Arial, sans-serif; color: #333; margin-bottom: 20px;">Data Guru</h3>
...
?>
    <tr>
        ...
        <td class="actions">
            <a href="delete-guru2.php?id=<?php echo $tampil['id_guru']; ?>"><i class="icon" data-feather="trash-2"></i></a>
            <a href="edit-guru2.php?id=<?php echo $tampil['id_guru']; ?>"><i class="icon" data-feather="edit"></i></a>
            <a href="tambah-guru2.php"><i class="icon" data-feather="plus-square"></i></a>
        </td>
    </tr>
<?php
}
...
<div class="center">
    <a href="tambah-guru2.php" class="btn-add">Tambah Guru</a>
</div>
